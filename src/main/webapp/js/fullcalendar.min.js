...
(function(m, oa) {
    ...
    function Zb(a, b) {
        ...
        function f(u) {
            var fa = m("<div class='fc-header-" + u + "'/>"); (u = b.header[u]) && m.each(u.split(" "),
            function(na) {
                na > 0 && fa.append("");
                var ga;
                m.each(this.split(","),
                function(ra, sa) {
                    if (sa == "title") {
                        ...
                        if (ha) {
                            ...
                            ma = m("<span class='fc-button fc-button-" + sa + " " + q + "-state-default'><span class='fc-button-inner'><span class='fc-button-content'>" + (ra ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + ra + "'/></span>": da) + "</span></span></span>");
                            if (ma) {
                                ma.click(function() {
    ...
    function Mb() {
        ...
        function d(Q) {
            ...
            if (Q.which == 1 && g("selectable")) {
                ...
                function(ra) {
                    fa.stop();
                    if (ga) { + ga[0] == +ga[1] && na(ga[0], true, ra);
                        e(ga[0], ga[1], true, ra)
                    }
                })
            }
    ...
    m.fn.fullCalendar = function(a) {
        ...
        a = m.extend(true, {},
        Ya, a.isRTL || a.isRTL === oa && Ya.isRTL ? xc: {},
        a);
